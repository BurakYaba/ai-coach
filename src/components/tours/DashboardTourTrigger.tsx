        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <button
              ...
              className="h-8 w-8 p-0 text-white/70 hover:text-white hover:bg-white/10 rounded-full transition-all duration-200 sm:h-9 sm:w-9 group bg-transparent border-0 cursor-pointer"
            >
