...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "/tr/blog/ielts-hazirlik-rehberi",
    languages: {
      en: "/blog/ielts-preparation-ai-guide",
      tr: "/tr/blog/ielts-hazirlik-rehberi",
    },
  },
  openGraph: {
      ...
      <main className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <header className="mb-8">
          ...
          <p className="text-xl text-muted-foreground mb-6">
            IELTS sınavına hazırlanmak için kapsamlı rehber. AI destekli pratik
            yöntemleri, puan artırma teknikleri ve başarı stratejileri ile
        ...
        <article className="prose prose-lg max-w-none">
          <div className="bg-gradient-to-r from-blue-50 to-green-50 dark:from-blue-950/20 dark:to-green-950/20 p-6 rounded-lg mb-8">
            ...
            <p>
              ...
              Üniversite başvuruları, iş başvuruları ve göçmenlik süreçlerinde
              kritik rol oynar. Fluenta'nın AI destekli IELTS hazırlık modülü
              ile hedeflediğiniz puanı alabilirsiniz.
            </p>
          </div>
