...
4. Provide gentle corrections when the user makes grammar or pronunciation errors, but prioritize communication
5. Use vocabulary and expressions appropriate for the level
`;
