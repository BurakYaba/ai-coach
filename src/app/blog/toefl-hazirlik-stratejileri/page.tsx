...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "/blog/toefl-hazirlik-stratejileri",
    languages: {
      en: "/en/blog/toefl-preparation-strategies",
      tr: "/blog/toefl-hazirlik-stratejileri",
    },
  },
  openGraph: {
...
const Tagline = ({ children }: { children: React.ReactNode }) => (
  <div className="relative z-1 max-w-[62rem] mx-auto text-center mb-[1rem] md:mb-4 lg:mb-[1.5rem]">
    <div className="inline-block px-4 py-2 rounded-full bg-gradient-to-r from-purple-100 to-blue-100 dark:from-purple-900/30 dark:to-blue-900/30 border border-purple-200/50 dark:border-purple-700/50">
      ...
      <main className="container mx-auto px-5 py-16 md:py-24 pt-24 space-y-16">
        ...
        <article className="max-w-4xl mx-auto">
          <header className="text-center space-y-4 mb-16">
            <Tagline>100+ Puan Hedefi</Tagline>
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              TOEFL iBT sınavına hazırlanmak için etkili stratejiler. AI
              destekli pratik yöntemleri, zaman yönetimi ve yüksek puan alma
              teknikleri ile hedeflediğiniz puanı alın.
            </p>
            ...
            <GradientCard>
              <div className="p-8">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  ...
                  Internet-Based Test), özellikle ABD ve Kanada'daki
                  üniversiteler tarafından kabul edilen İngilizce yeterlilik
                  sınavıdır. Fluenta'nın AI destekli TOEFL hazırlık modülü ile
                  100+ puan hedefine ulaşabilirsiniz.
                </p>
              </div>
            </GradientCard>
          </section>
