...
export const tourSteps: Record<string, TourStep[]> = {
  ...
  listening: [
    {
      id: "listening-welcome",
      title: "Welcome to Listening Module!",
      content:
        "Improve your listening comprehension with diverse audio content and interactive exercises.",
      target: "h1",
      position: "bottom",
      tips: [
        "Listen to content slightly above your comfort level",
    ...
    },
    {
      ...
      title: "Audio Content",
      content:
        "Listen to various types of content: conversations, lectures, podcasts, and news adapted to your level.",
      target: "[data-tour='audio-player']",
      position: "right",
      tips: [
        "Use subtitles if available when starting",
        "Try listening without subtitles for challenge",
      ],
    },
    {
      ...
      content:
        "Follow along with synchronized transcripts. Click on words or phrases to hear them repeated.",
      target: "[data-tour='transcript']",
      position: "left",
      tips: [
        "Read along while listening for better comprehension",
    ...
    },
    {
      ...
      content:
        "Test your understanding with various question types: multiple choice, fill-in-the-blanks, and more.",
      target: "[data-tour='listening-exercises']",
      position: "bottom",
      tips: [
        "Listen to the audio multiple times if needed",
